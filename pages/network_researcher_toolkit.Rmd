...
[Statnet](https://statnet.org/) is a family of R packages built for modeling and simulating exponential random graph models. These models allow you to keep some aspects of your network constant, and generate artificial networks withing those constraints. You can then compare your network to the artificial simulations to check for significance against random chance. Some plotting and descriptive tools are also provided. The family includes:

* [ergm](https://github.com/statnet/ergm) – Analyze and simulate networks using exponential-family random graph models. 
* [tergm](https://github.com/statnet/tergm) – Analyze dynamic or evolving network data using temporal exponential random graph models. 
* [latentnet](https://github.com/statnet/latentnet) – Fit and simulate latent space models of networks.
* [EpiModel](https://github.com/statnet/EpiModel) –  Tools for simulating mathematical models of infectious disease dynamics.

### igraph

[igraph](https://igraph.org/r/) Offers a host of visualization and analysis tools for networks. If you're interested in calculating things like degree distribution and centrality measures this is a good place to start. It has an R and python version and can also be used with Mathematica and C/C++.

* [netCoin](https://cran.r-project.org/web/packages/netCoin/index.html) - A package for analyzing coincidence networks (particularly relevant to ecologists), equipped with broadly useful functions to build interactive and easily shareable network visualizations.

### intergraph

[intergraph](http://mbojan.github.io/intergraph/) provides tools for converting between networks created using the igraph and statnet packages in R.

## Visualization

### visNetwork

[visNetwork](https://github.com/datastorm-open/visNetwork) is a great package for turning network plots into interactive html objects. Networks that are not small can be difficult to visualize, and it’s often useful to create interactive plots to expand the amount of data you show. It works well with networks created in igraph.

### ggraph

[ggraph](https://github.com/thomasp85/ggraph) is used for network plotting in R‘s ggplot/tidyverse framework. This package has supplanted the ggnetwork package.
...
[NetworkX](https://networkx.org/) is by far the most common network analysis tool for python. It the backbone of many other network packages with more specific uses.

### igraph

[igraph](https://igraph.org/python/) from R also has a python module.
...
* [Jane Carlen](https://jcarlen.github.io/)
