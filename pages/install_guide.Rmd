...
Python modules are extensions to the basic capabilities of Python. You can install modules from the terminal where you call Python. The same proces will apply regardless of your operating system.
