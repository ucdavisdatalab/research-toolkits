...
If you are installing R/RStudio on a Mac, there is no extra configuration. Simply go the download pages for [R](https://www.r-project.org/){rel="noopener noreferrer" target="_blank"} and [RStudio](https://rstudio.com/){rel="noopener noreferrer" target="_blank"} and choose the latest version for mac. Run the installer package when it is finished downloading.
