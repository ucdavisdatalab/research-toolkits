...
The following are some tools you can use for NLP. Many of these tools have been implemented in larger data analysis suites like python and R as packages, so it would be rather unusual to use them standalone. If this is the case, the tool is marked with an asterisks (*) next to it's name.
