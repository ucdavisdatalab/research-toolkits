...
* [A Gentle Introduction to GIS](https://docs.qgis.org/3.4/en/docs/gentle_gis_introduction/)
* [GIS fundamentals: a first text on geographic information systems by Paul Bolstad](https://search.library.ucdavis.edu/permalink/f/t3kr8e/01UCD_ALMA21327592230003126)
...
|:-|:-|:-|
|Mac, Windows, Linux|Free|[QGIS.org](https://qgis.org/)|
...
* [Intro to Desktop GIS with QGIS by Michele Tobias](https://github.com/MicheleTobias/Intro-to-Desktop-GIS-with-QGIS)

### ArcGIS & Other ESRI Tools

|Platforms|Cost|Download|
|:-|:-|:-|
|Windows|Free for the 2019 license year to UC Davis affiliates; costly to purchase on your own |[UC Davis IT Service Catalog: ESRI ArcGIS](https://itcatalog.ucdavis.edu/service/arcgis-geographic-software)|
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Mac, Windows, Linux|Free|[OSGeo’s GRASS Page](https://grass.osgeo.org/)|

Learning:

* [Documentation](https://grass.osgeo.org/documentation/)
* [First Time Users](https://grass.osgeo.org/documentation/first-time-users/)
* [Tutorials](https://grass.osgeo.org/documentation/tutorials/%20Tutorials)
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Windows|Contact Hexagon Geospatial; cost depends on features needed|[Product Profile](https://www.hexagongeospatial.com/products/power-portfolio/erdas-imagine)|

Learning:

* [Tutorials from Hexagon Geospatial](https://community.hexagongeospatial.com/t5/ERDAS-IMAGINE-Tutorials/tkb-p/KS_ERDAS_IMAGINE_Tutorials)
...
* [Tutorials from Harris Geospatial](https://www.harrisgeospatial.com/Support/Self-Help-Tools/Tutorials)
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Windows|Contact Trimble|[Trimble’s eCognition Site](http://www.ecognition.com/)|

Learning:

* [Trimble’s eCognition Training Site](http://www.ecognition.com/support/training)
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Windows, Mac, & Linux|Free|[SpatiaLite Download Page](https://www.gaia-gis.it/fossil/libspatialite/index)|

Learning:

* [Spatial SQL Workshop by Michele Tobias](https://github.com/MicheleTobias/Spatial_SQL)
* [Installation Instructions](https://github.com/MicheleTobias/Spatial_SQL/blob/master/Install.md)

### PostGIS

|Platforms|Cost|Download|
|:-|:-|:-|
|Windows, Mac, & Linux|Free|[PostGIS Homepage](https://postgis.net/)|
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Windows, Mac, & Linux|Free|[The R Project](https://www.r-project.org/)|

Learning:

* [R Spatial](https://rspatial.org/)
* [The Carpentries’ Geospatial Workshop](https://datacarpentry.org/geospatial-workshop/)
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Windows, Mac, & Linux|Free|[Python Software Foundation](https://www.python.org/downloads/)|

Learning:

* [GeoPandas Tutorial](http://geopandas.org/)
* [#maptimeDavis Python Geospatial Workshop Materials](https://github.com/MicheleTobias/MaptimeDavis/tree/master/PythonGeospatial)
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Online|Access is free but an application is required. Usually academic and research usage is accepted.|[Google Earth Engine Access Request Page](https://signup.earthengine.google.com/#!/)|

Learning:

* [#maptimeDavis Google Earth Engine Workshop Materials](https://github.com/MicheleTobias/MaptimeDavis/tree/master/GoogleEarthEngine)
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Windows, Mac, & Linux|Free|[GDAL Homepage](https://gdal.org/)|
...
* [GDAL Tutorial Page](https://gdal.org/tutorials/index.html)
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Windows, Mac, & Linux|Free|[PDAL Homepage](https://pdal.io/)|

Learning:

* [PDAL Tutorial Page](https://pdal.io/tutorial/index.html)

### GRASS

See the Desktop GIS section above for more details. GRASS can also be used from the commandline. See the [GRASS and Shell](https://grasswiki.osgeo.org/wiki/GRASS_and_Shell) page for examples and explanations.
...
[Project Homepage](https://leafletjs.com/)
...
[Project Homepage](https://github.com/tomchadwin/qgis2web/wiki)
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Windows|Typically licenses are offered on a subscription (yearly or monthly) basis.|[Pix4D Homepage](https://www.pix4d.com/)|

Learning:

* [Pix4D Training Site](https://www.pix4d.com/services/training-certification)
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Windows, Mac, & Linux|Typically licenses are offered on a subscription (yearly or monthly) basis.|[Agisoft Homepage](https://www.agisoft.com/)|

Learning:

* [Agisoft User Manuals](https://www.agisoft.com/downloads/user-manuals/)
...
|Platforms|Cost|Download|
|:-|:-|:-|
|Linux (but the docker method of running it on Windows and Mac is [fairly well documented](https://www.opendronemap.org/docs/)|Free to run the software yourself with paid options for services run by the ODM team.|[ODM Homepage](https://www.opendronemap.org/)|

Learning:

* [ODM Documentation](https://www.opendronemap.org/docs/)

# Campus Resources

## Drop-In Hours

Geospatial Drop-In Hours are now a part of the [DataLab Drop-In Hours](https://datalab.ucdavis.edu/office-hours/).

You can also schedule one-on-one or group consultations with Michele Tobias, GIS Data Curator.

## Geospatial Email List

UC Davis affiliates can sign up for email lists through the [UC Davis Information & Educational Technology’s Sympa list serve manager](https://lists.ucdavis.edu/sympa/). The [Geospatial email list](https://lists.ucdavis.edu/sympa/info/geospatial) is a widely-used list for UC Davis faculty, students, staff, and local community members who work with any type of geospatial data. The list can be used for announcements or questions.

## UC Davis Slack Channels

[UC Davis Slack](https://itcatalog.ucdavis.edu/service/slack) has several channels related to spatial data and tools.
...
Workstation use must comply with [UC Davis Computer Use Policies](https://computerrooms.ucdavis.edu/policies.html) and the [Library Computer Use Policy](https://www.library.ucdavis.edu/library-policies/). GIS software and data licensed by the library may not be used for commercial purposes. Save your data and project files to portable media.

## Classes

Whether you’re just getting started with geospatial technologies or you’re looking for a way to advance your skills, here are some classes to consider at UC Davis. The quarter listed may change. Consult with the schedule of classes or the professor for each class. Please also see the [Geography Graduate Group’s list of Methods, Models, & GIS Depth Courses](https://geography.ucdavis.edu/methods-models-and-gis-science-courses) for a broader list of possible courses. The [UC Davis Continuing & Professional Education](https://extension.ucdavis.edu/subject-areas/geographic-information-systems) (formerly the Extension) also offers courses in GIS aimed at working professionals. The Center for Spatial Sciences maintains [a list of upcoming, current, and past classes](https://spatial.ucdavis.edu/teaching/), including 198/298 group studies. Join the [Geospatial email list](https://lists.ucdavis.edu/sympa/info/geospatial) to get annoucements about upcoming classes and workshops.
...
* [Michele Tobias](https://sites.google.com/site/mtobiasresearch/home)
